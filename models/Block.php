...
class Block extends \minerva\models\MinervaModel {
	...
	protected $_schema = array(
		...
		'content' => array(
			...
			'form' => array(
				'label' => 'Block Content',
				'type' => 'textarea',
				'after' => '(you may use html code)'
			)
		),
		// options contain all sorts of misc. data like "weight" or "position" or "is_menu" it
		// could also contain "pubished" flags if desired, but minerva core doesn't care about
		// publish status on blocks so no dedicated field is set for it
	...
	// "Create Block" ... "Create Special Block" etc.
