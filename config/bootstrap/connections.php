...
// Connection information can be set from the main app with
// Libraries::add('minerva', array('connections' => array(...)));

//@todo: probably a bad idea: fetching data form a global namespace?
