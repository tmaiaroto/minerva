 ...
 * more robust in the future that may even automatically handle obtaining these dependencies
 * for you.
 *
*/
...
Dispatcher::applyFilter('run', function($self, $params, $chain) {
	...
	if (isset($params['request']->params['library']) && $params['request']->params['library'] == 'minerva') {
        ...
        // Check for these libraries for the CMS
        // these can be specified as key => value or just a value if not providing a link.
		$library_deps = array(
