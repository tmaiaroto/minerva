<?php
namespace app\libraries\blog\models;
...
class Page extends \app\models\Page {
	...
	public static $fields = array(
			...
			'author' => array(),
			'body' => array('label' => 'Page Copy', 'type' => 'textarea'),
			'image' => array('label' => 'Preview Image', 'type' => 'file')	
	);
	...
	public static function __init() {		
		...
		if($_SERVER['QUERY_STRING'] == 'url=pages/index/blog') {
			\app\models\Page::applyFilter('find', function($self, $params, $chain) {
