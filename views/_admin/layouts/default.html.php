...
<head>
	...
	<?php	// Flip between "960" and "grid" style sheets for fluid vs. fixed 960gs
		...
		echo $this->html->script(array('https://ajax.googleapis.com/ajax/libs/jquery/1.5.2/jquery.min.js', 'https://ajax.googleapis.com/ajax/libs/jqueryui/1.8.11/jquery-ui.min.js', '/minerva/js/jquery/jquery.tipsy.js', '/minerva/js/tiny_mce/jquery.tinymce.js'), array('inline' => false));
	?>
