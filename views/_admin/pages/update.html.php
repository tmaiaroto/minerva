...
<div class="grid_12">
	...
	<fieldset class="admin">
		...
		?>
	    <?=$this->form->submit('Edit ' . $display_name); ?> <?=$this->html->link('Cancel', array('admin' => 'admin', 'library' => 'minerva', 'controller' => 'pages', 'action' => 'index', 'document_type' => $document->document_type)); ?>
	</fieldset>
