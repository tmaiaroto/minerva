	...
	<div id="container">
		<div id="header">
			...
			<p>
				...
				<code><?php
					echo realpath(LITHIUM_APP_PATH . '/libraries/minerva/views/layouts/error_development.html.php');
				?></code>
			</p><p>
				To modify your error-handling configuration, see
				<code><?php
					echo realpath(LITHIUM_APP_PATH . '/libraries/minerva/config/bootstrap/errors.php');
				?></code>
			</p>
		</div>
		<div id="content">
