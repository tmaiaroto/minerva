...
class MinervaControllerTest extends \lithium\test\Unit {
    ...
    public function tearDown() {
        $documents = Page::find('all', array('conditions' => array('url' => array('test-page', 'second-test-page'))));
    ...
    public function testGetDocument() {
        // find_type will be false, but the request is authenticated, it will return true for having permission
    ...
    // tests a lot of the Minerva controller initialization process as well as the method to return it
