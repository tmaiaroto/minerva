        ...
        switch ($type) {
            case 'first':
                return new Document(array('data' => array(
                    '_id' => 1, 'email' => 'someone@somewhere.com', 'first_name' => 'John', 'last_name' => 'Doe'
                )));
            break;
            case 'all':
            default :
                return new DocumentSet(array('data' => array(
                    array('_id' => 1, 'email' => 'someone@somewhere.com', 'first_name' => 'John', 'last_name' => 'Doe'),
                    array('_id' => 2, 'email' => 'someone_else@somewhere.com', 'first_name' => 'Henry', 'last_name' => 'Ford'),
                    array('_id' => 3, 'email' => 'someone_again@somewhere.com', 'first_name' => 'Betty', 'last_name' => 'Crocker')
                )));
            break;
        }
    }
