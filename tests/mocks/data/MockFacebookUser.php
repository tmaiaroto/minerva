        ...
        switch ($type) {
            case 'first':
                return new Document(array('data' => array(
                    '_id' => 1, 'email' => null, 'first_name' => null, 'last_name' => null, 'facebook_uid' => '100'
                )));
            break;
            case 'all':
            default :
                return new DocumentSet(array('data' => array(
                    array('_id' => 1, 'email' => null, 'first_name' => null, 'last_name' => null, 'facebook_uid' => '100'),
                    array('_id' => 2, 'email' => null, 'first_name' => null, 'last_name' => null, 'facebook_uid' => '200'),
                    array('_id' => 3, 'email' => null, 'first_name' => null, 'last_name' => null, 'facebook_uid' => '300')
                )));
            break;
        }
    }
